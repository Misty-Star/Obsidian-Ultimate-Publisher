...
const REFERENCE_PLATFORM_MIGRATION_MATRIX: Array<{
  ...
  { referencePlatform: "Notion", status: "planned", rationale: "API provider not exposed until publish/update tests exist." },
  { referencePlatform: "Halo API", status: "planned", rationale: "API provider not exposed until publish/update tests exist." },
  { referencePlatform: "Telegraph", status: "planned", rationale: "API provider not exposed until publish/update tests exist." },
  { referencePlatform: "Confluence", status: "planned", rationale: "API provider not exposed until publish/update tests exist." },
  { referencePlatform: "WordPress", status: "implemented", providerId: "wordpress", rationale: "Existing WordPress REST provider." },
  { referencePlatform: "WordPress.com", status: "planned", rationale: "Separate API/XML-RPC decision remains open." },
  { referencePlatform: "MetaWeblog", status: "planned", rationale: "XML-RPC helper must be introduced before exposure." },
  { referencePlatform: "CNBlogs", status: "planned", rationale: "Depends on XML-RPC helper." },
  { referencePlatform: "Typecho", status: "planned", rationale: "Depends on XML-RPC helper." },
  { referencePlatform: "Jvue", status: "planned", rationale: "Depends on XML-RPC/helper API confirmation." },
  ...
  { referencePlatform: "Halo web", status: "planned", rationale: "Split from Halo API only if required." },
  ...
  { referencePlatform: "LocalSystem", status: "implemented", providerId: "local-filesystem", rationale: "Vault-relative local Markdown export provider." },
